...
// include("Class/db.php");
    ...
    if(!isset($_SESSION['ID'])){
        ...
        <p>Sistem Logout. Anada harus melakukan Login kembali.</p>
...
<html>
    ...
    <body>
        <?php
            ...
            // $showUsers = mysqli_query($conn, $query = "SELECT * FROM users WHERE ID='$_SESSION['ID']'");
                            ...
                            <div class="row align-items-center">  
                                <div class="row align-items-center">
                                    ...
                                    <div class="media align-items-end profile-header">
                                        ...
                                        <h3 font face="Courier New" color="dark" size="3"><?=$user['userName']?></h3> 
                                        <div> 
